...
- `LuaAPI.cpp`, `LuaAPI_Memory.cpp`, `LuaAPI_ImGui.cpp` — C++ bindings exposed to Lua scripts for memory operations and ImGui drawing.
...
- **Conditional compilation**: `HAVE_CAPSTONE` gates disassembly features; `HAVE_LUAJIT` gates Lua scripting. Both are set automatically by CMake based on library availability.
