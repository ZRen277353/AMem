...
- Scan: scan_set_range(memory_type="all"), scan_value(value, data_type="dword", scan_type="exact"), scan_next(value, data_type="dword", scan_type="exact"), scan_fuzzy(data_type="dword", scan_type="unknown"), scan_hex(hex_pattern), get_scan_count, get_scan_results(offset=0, count=100), clear_scan.
