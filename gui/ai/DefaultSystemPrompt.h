...
- Memory: memory_read(address, size=256), read_value(address, data_type="dword"), write_bytes(address, hex_string), memory_write(address, data_hex), write_value(address, value, data_type="dword").
