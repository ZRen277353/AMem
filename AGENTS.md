...
These byte limits do not replace provider-aware context budgeting, pagination, or allocation-aware parsing. nlohmann JSON DOM overhead can exceed source bytes, and real provider HTTP/TLS/full-response integration is not yet automated.
